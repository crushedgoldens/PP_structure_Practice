...
def init_args():
    ...
    parser.add_argument("--image_dir", type=str,default="../../doc/imgs_target/")
    parser.add_argument("--page_num", type=int, default=0)
    parser.add_argument("--det_algorithm", type=str, default='DB')
    parser.add_argument("--det_model_dir", type=str, default="../../inference/ch_PP-OCRv3_det_infer/")
    ...
    parser.add_argument("--rec_model_dir", type=str, default="../../inference/ch_PP-OCRv3_rec_infer/")
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default="../../ppocr/utils/ppocr_keys_v1.txt")#识别改为中文路径
