...
def init_args():
    ...
    parser.add_argument("--table_model_dir", type=str, default='../inference/ch_ppstructure_mobile_v2.0_SLANet_infer/')
    parser.add_argument(
    ...
    parser.add_argument("--ser_model_dir", type=str, default='../inference/ser_LayoutLMv2_xfun_zh_infer/')
    parser.add_argument("--re_model_dir", type=str, default='../inference/re_vi_layoutxlm_xfund_infer')
